...
import "./Intro.css";
 import Profile from "../../img/codingimgsmall.jpg";
    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Fatima Khan</h1>
          ...
          <p className="i-desc">
          Aiming  to provide high-impact web solutions for diverse industry organizations. 
